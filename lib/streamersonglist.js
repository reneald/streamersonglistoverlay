...
function updateQueueSuccess(data) {
    ...
    showCurrentlyPlaying(queuePosition);
    ...
    queuePosition.forEach(function (item, index) {
        if (haveMore) {
            let artist = '<span class="' + artistClass + '">' + item.song.artist + '</span>';
            let title = '<span class="' + titleClass + '">' + item.song.title + '</span>';
...
function showCurrentlyPlaying(queue) {

}

function showSongInList(song) {
    let artist = '<span class="' + artistClass + '">' + item.song.artist + '</span>';
            let title = '<span class="' + titleClass + '">' + item.song.title + '</span>';
            let div = '<div>' + artist + title + '</div>';
            $('#queue-wrapper').append(div);
